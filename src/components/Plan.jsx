...
const Plan = () => {
  return (
    <div className='max-w-[1400px] m-auto my-16 px-4 grid lg:grid-cols-2 gap-4'>
      ...
      <div className='flex flex-col h-full justify-center'>
        ...
        <p className='text-2xl py-6'>Combine local public transit cycle routes, bike sharing and walking.</p>
        <p className='pb-6'>Combine local public transit (bus, train, ferry, tram, subway, metro, rail) with routes and car sharing, motorbike, cycle routes, bike sharing and walking , taxi, cabs, ride share, shuttle services.</p>
        <div>
